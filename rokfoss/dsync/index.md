...
다운로드는 아래 명령어로 가능합니다. (대부분의 리눅스에서 사용 가능)

2026년 02월 20일 기준 최신 버전은 26.2.1 입니다.

2026년부터는 더 이상 실행파일 직접 다운로드를 통한 실행을 지원하지 않습니다. 사용 중인 리눅스에 맞게 ROKFOSS 패키지센터를 추가하여 설치해주십시오.
